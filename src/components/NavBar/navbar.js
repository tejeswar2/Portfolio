  ...
  return (
    <nav className='navbar'>
        ...
        <div className='desktopMenu'>
            ...
            <Link activeClass='active' to='proj' spy={true} smooth={true} offset={-100} duration={500} className='desktopMenuListItem'>Projects</Link>
        ...
        <div className='navMenu' style={{display: showMenu? 'flex':'none'}}>
            ...
            <Link activeClass='active' to='proj' spy={true} smooth={true} offset={-50} duration={500} className='listItem' onClick={()=>setshowMenu(false)}>Projects</Link>
